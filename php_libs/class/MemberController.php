...
class MemberController extends BaseController
{
    ...
    //----------------------------------------------------
    // 20190318 ゲスト用メニュー typeが決まっていなければscreen_login関数が実行される
    //----------------------------------------------------
    ...
    public function screen_top()
    {
        ...
        //$this->file = 'member_top.php';     //4.24 ここをphpファイルに変更
        
        $this->view_display();
        
        // 修正 20190430
        // 会員TOP画面に、lib_02.php に定義されている予定表を表示する関数を実行する。
        show_yotei();
    }
